    ...
    { key: 'nama', label: 'Nama', render: (u: UserData) => (
      <div className="flex items-center gap-2.5">
        ...
        <div>
          ...
          {u.id === user.id && <span className="text-[10px] text-persian-blue font-bold">ΓùÅ Anda</span>}
        </div>
      </div>
    )},
        ...
        <div className="space-y-4">
          ...
          <div className="p-3 rounded-xl bg-amber-500/10 border border-white/10 flex gap-2.5 text-xs text-amber-400">
            ...
            <div><strong>Hak Akses:</strong><br/>
              <span className="text-unit-programming font-bold">Programming</span> ΓåÆ hanya data Programming<br/>
              <span className="text-blue-300">English</span> ΓåÆ hanya data English Club<br/>
              <span className="text-blue-300">OSIS & MPK</span> ΓåÆ hanya data OSIS & MPK<br/>
              <span className="text-amber-400">Administrator</span> ΓåÆ semua data + log aktivitas
            </div>
          </div>
        </div>
      </Modal>
