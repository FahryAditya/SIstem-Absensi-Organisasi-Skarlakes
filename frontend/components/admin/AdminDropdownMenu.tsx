    ...
    <div ref={containerRef} className="relative z-40">
      ...
      <button
        ...
        className={`btn-secondary flex items-center gap-2 font-bold px-4 py-2 border transition-all duration-300 ${
          isOpen 
            ? 'bg-royal-600/20 border-royal-500/50 text-white shadow-[0_0_15px_rgba(30,144,255,0.2)]' 
            : 'text-royal-400 border-white/10 hover:border-royal-500/30'
        }`}
      >
        <span>Menu Pengelola</span>
        <ChevronDown 
          className={`w-4 h-4 transition-transform duration-300 ${isOpen ? 'rotate-180 text-white' : 'text-royal-400'}`} 
        />
      </button>
      ...
      <div
        ref={menuRef}
        className="absolute right-0 top-full mt-2 w-[95vw] sm:w-[640px] md:w-[760px] lg:w-[960px] bg-royal-950/95 backdrop-blur-xl border border-white/10 rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.5)] overflow-hidden"
        ...
        <div className="p-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          >
            ...
            <div className="flex flex-col gap-2">
              <button
                ...
                className="flex items-center justify-between w-full px-3 py-2 text-xs font-semibold text-royal-300 hover:text-white rounded-lg bg-white/5 hover:bg-white/10 transition-all text-left"
              >
          ...
          >
            ...
            <div className="flex flex-col gap-2">
              ...
              >
                <span className="flex items-center gap-2">
                  <Cpu className="w-3.5 h-3.5 text-royal-400" />
                  Optimalkan DB
                </span>
                <ArrowUpRight className="w-3 h-3 opacity-50" />
              </button>
              ...
              >
                <span className="flex items-center gap-2">
                  <Database className="w-3.5 h-3.5 text-royal-400" />
                  Backup SQL
                </span>
                <ArrowUpRight className="w-3 h-3 opacity-50" />
              </button>
          ...
          >
            <div className="text-sm font-black text-white/90 border-b border-white/10 pb-2 mb-3 flex items-center gap-2">
              <span className="w-1.5 h-1.5 rounded-full bg-yellow-bright-400" />
            ...
            <div className="flex flex-col gap-2">
              ...
              >
                <span className="flex items-center gap-2">
                  <Plus className="w-3.5 h-3.5 text-yellow-bright-400" />
                  Tambah User
                </span>
                <ArrowUpRight className="w-3 h-3 opacity-50" />
              </button>
              ...
              >
                <span className="flex items-center gap-2">
                  <Database className="w-3.5 h-3.5 text-yellow-bright-400" />
                  Riwayat Aktivitas
                </span>
                <ArrowUpRight className="w-3 h-3 opacity-50" />
              </button>
              ...
              >
                <span className="flex items-center gap-2">
                  <ArrowUpRight className="w-3.5 h-3.5 text-yellow-bright-400" />
                  Export Data (XLS)
                </span>
                <ArrowUpRight className="w-3 h-3 opacity-50" />
              </button>
              ...
              >
                <span className="flex items-center gap-2">
                  <Cpu className="w-3.5 h-3.5 text-yellow-bright-400" />
                  Statistik Sistem
                </span>
                <ArrowUpRight className="w-3 h-3 opacity-50" />
              </button>
          ...
          >
            ...
            <div className="flex flex-col gap-2">
              ...
              >
                <span className="flex items-center gap-2">
                  <Users className="w-3.5 h-3.5 text-royal-400" />
                  Manajemen Anggota
                </span>
                <ArrowUpRight className="w-3 h-3 opacity-50" />
              </button>
              ...
              >
                <span className="flex items-center gap-2">
                  <CalendarCheck className="w-3.5 h-3.5 text-royal-400" />
                  Modul Absensi
                </span>
                <ArrowUpRight className="w-3 h-3 opacity-50" />
              </button>
              ...
              >
                <span className="flex items-center gap-2">
                  <Wallet className="w-3.5 h-3.5 text-royal-400" />
                  Manajemen Kas
                </span>
                <ArrowUpRight className="w-3 h-3 opacity-50" />
              </button>
