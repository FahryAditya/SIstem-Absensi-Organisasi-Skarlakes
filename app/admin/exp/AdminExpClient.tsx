                  ...
                  {selectedMember ? (
                    <div className="flex items-center justify-between w-full pr-2">
                      ...
                      <div className="flex items-center gap-2">
                        <span className="text-xs bg-white/20 text-blue-400 px-2 py-0.5 rounded font-bold">
                              ...
                              >
                                ...
                                <div className="flex items-center gap-3">
                                  <div className="flex items-center gap-1.5">
                                    <span className="text-xs bg-white/10 text-blue-400 px-1.5 py-0.5 rounded font-semibold">
                                      Lv.{m.level}
                                    </span>
