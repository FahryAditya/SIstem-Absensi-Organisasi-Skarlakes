          ...
          <div className="bg-royal-950/50 border border-white/10 rounded-2xl p-6 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="p-3 bg-white/[0.02] border border-white/5 rounded-xl">
                <span className="text-xs font-bold text-royal-400 block mb-1">Kolom Wajib (Required)</span>
                <ul className="text-[11px] text-royal-400 space-y-1 list-disc pl-4">
              ...
              <div className="p-3 bg-white/[0.02] border border-white/5 rounded-xl">
                <span className="text-xs font-bold text-yellow-bright-400 block mb-1">Kolom Opsional (Optional)</span>
                <ul className="text-[11px] text-royal-400 space-y-1 list-disc pl-4">
