  ...
  return (
    <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
      <div className="xl:col-span-2 space-y-6">
        ...
        <div className="card p-5 space-y-3">
          <div className="flex items-center gap-2 mb-1">
            <span className="w-6 h-6 rounded-full bg-royal-600 text-white text-xs font-black flex items-center justify-center">1</span>
            <h3 className="text-sm font-bold text-royal-200">Pilih Data Export</h3>
          </div>
        ...
        <div className="card p-5 space-y-4">
          <div className="flex items-center gap-2 mb-1">
            <span className="w-6 h-6 rounded-full bg-royal-600 text-white text-xs font-black flex items-center justify-center">2</span>
            <h3 className="text-sm font-bold text-royal-200">Atur Filter</h3>
          </div>
          ...
          <div className="rounded-lg border border-royal-800/30 bg-cream-50/5 p-3 text-xs text-royal-200 leading-relaxed">
        ...
        <div className="card p-5">
          <div className="flex items-center gap-2 mb-4">
            <span className="w-6 h-6 rounded-full bg-royal-600 text-white text-xs font-black flex items-center justify-center">3</span>
            <h3 className="text-sm font-bold text-royal-200">Download File</h3>
          </div>
          ...
          <div className="mt-4 space-y-1.5 text-xs text-royal-400">
      ...
      <div className="space-y-6 pt-6">
        ...
        {isSuperAdmin && (
          <div className="card p-5 border-royal-800/30 bg-red-500/40">
            ...
            <div className="space-y-3">
              ...
              <div className="form-group">
                ...
                />
                <p className="text-xs text-royal-400 mt-1">{clearOptions.find(o => o.value === clearType)?.desc}</p>
              </div>
              <div className="form-group">
              ...
              <button onClick={handleClearDatabase} disabled={clearing || clearConfirm !== expectedConfirm} className="btn-secondary w-full justify-center text-red-400 border-royal-800/30 hover:bg-red-500/10">
