  ...
  return (
    <div className="p-6 max-w-4xl mx-auto space-y-8">
      ...
      <div className="flex items-center gap-4">
        <button
          onClick={() => router.back()}
          className="p-2 hover:bg-royal-800/50 rounded-xl transition-colors"
        >
          <ChevronLeft className="w-6 h-6 text-royal-300" />
        </button>
        <div className="flex items-center gap-3">
          <div className="p-2 bg-royal-600/10 rounded-xl border border-royal-500/20 shadow-sm">
      ...
      {/* Form Card */}
      <div className="bg-royal-950 border border-royal-800/30 rounded-3xl p-8 shadow-sm">
        <DocumentationForm
