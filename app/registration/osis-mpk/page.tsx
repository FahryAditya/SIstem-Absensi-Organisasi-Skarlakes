        ...
        <div className="bg-white/[0.03] backdrop-blur-3xl rounded-[2.5rem] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.6)] overflow-hidden border border-white/10 slide-up">
          ...
          <form onSubmit={handleSubmit} className="p-10 space-y-8">
            ...
            <div className="space-y-3">
              <label className="text-xs font-black uppercase tracking-[0.2em] text-royal-500 ml-1">Identitas Calon</label>
            ...
            <div className="space-y-3">
              <label className="text-xs font-black uppercase tracking-[0.2em] text-royal-500 ml-1">Kredensial Siswa</label>
              <div className="space-y-4">
                <div className="relative group">
                  <input
                    required
...
export default function RegistrationOsisMpkPage() {
  return (
    <Suspense fallback={<div className="min-h-screen flex items-center justify-center bg-[#000B18]"><Loader2 className="w-8 h-8 animate-spin text-royal-400" /></div>}>
