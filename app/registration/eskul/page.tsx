    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#001F3F] p-4 relative overflow-hidden">
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-8 rounded-3xl shadow-2xl max-w-md w-full text-center relative z-10">
          ...
          <p className="text-royal-100/60 mb-6">{error}</p>
    ...
    <div className="min-h-screen bg-[#000B18] py-20 px-4 relative overflow-hidden flex flex-col items-center font-sans">
      ...
      <div className="max-w-2xl w-full relative z-10">
        <button 
          ...
          className="flex items-center gap-3 text-royal-400 hover:text-white mb-10 transition-all group slide-up px-2"
        >
        ...
        <div className="bg-white/[0.03] backdrop-blur-3xl rounded-[2.5rem] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.6)] overflow-hidden border border-white/10 slide-up">
          <div className="bg-gradient-to-br from-royal-600/20 to-royal-700/20 p-10 text-center border-b border-white/5 relative">
            <div className="absolute inset-0 bg-gradient-to-b from-white/5 to-transparent pointer-events-none" />
            <h1 className="text-4xl font-black text-white mb-3 tracking-tight">Formulir Pendaftaran</h1>
            <p className="text-royal-400 font-bold uppercase tracking-[0.2em] text-[10px]">{org?.nama}</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-10 space-y-8">
            ...
            <div className="space-y-3">
              <label className="text-xs font-black uppercase tracking-[0.2em] text-royal-500 ml-1">Informasi Personal</label>
              <div className="space-y-4">
                <div className="group relative">
                  <input
                    ...
                    className="w-full px-6 py-4 rounded-2xl bg-white/[0.03] border border-white/10 text-white placeholder:text-white/20 focus:ring-2 focus:ring-royal-500 focus:border-transparent outline-none transition-all group-hover:bg-white/[0.05]"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="relative group">
                    <select
                      required
                      className="w-full px-6 py-4 rounded-2xl bg-white/[0.03] border border-white/10 text-white focus:ring-2 focus:ring-royal-500 outline-none transition-all appearance-none cursor-pointer group-hover:bg-white/[0.05]"
                    ...
                    <ChevronDown className="absolute right-6 top-1/2 -translate-y-1/2 w-4 h-4 text-royal-500 pointer-events-none group-hover:text-white transition-colors" />
                  </div>
                  ...
                  <div className="relative group">
                    ...
                    >
                      ...
                      <optgroup label="SKARLA" className="bg-[#000B18] font-bold text-royal-400">
                      ...
                      <optgroup label="SKAKES" className="bg-[#000B18] font-bold text-royal-400">
            ...
            <div className="space-y-3">
              <label className="text-xs font-black uppercase tracking-[0.2em] text-royal-500 ml-1">Kredensial & Kontak</label>
              <div className="space-y-4">
                <div className="relative group">
                  <input
                    required
                    ...
                    className={`w-full px-6 py-4 rounded-2xl bg-white/[0.03] border text-white placeholder:text-white/20 outline-none transition-all group-hover:bg-white/[0.05] ${
                      ...
                      emailAvailable === false ? 'border-red-500/50 ring-4 ring-red-500/10' : 'border-white/10 focus:ring-2 focus:ring-royal-500'
                    }`}
                  ...
                  {emailAvailable === false && (
                    <p className="text-[10px] text-red-400 font-bold uppercase tracking-wider mt-2 ml-1">Email sudah terdaftar</p>
                  )}
                </div>
            ...
            <button
              ...
              type="submit"
              className="w-full py-5 bg-gradient-to-r from-royal-600 to-royal-700 hover:from-royal-600 hover:to-royal-700 text-white rounded-2xl font-black uppercase tracking-[0.2em] text-xs shadow-2xl shadow-royal-900/40 active:scale-[0.98] transition-all disabled:opacity-50 disabled:active:scale-100 flex items-center justify-center gap-3 mt-10"
            >
              {submitting ? (
                <>
        ...
        <p className="mt-8 text-center text-[10px] font-bold uppercase tracking-[0.3em] text-royal-600">
          Data Anda dilindungi oleh sistem enkripsi SKARLAKES
        </p>
      </div>
...
export default function RegistrationEskulPage() {
  return (
    <Suspense fallback={<div className="min-h-screen flex items-center justify-center bg-[#001F3F]"><Loader2 className="w-8 h-8 animate-spin text-royal-400" /></div>}>
