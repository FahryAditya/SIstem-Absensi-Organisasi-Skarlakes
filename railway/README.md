...
Folder ini berisi semua file konfigurasi untuk deploy **MySQL database di Railway.app**
...
├── railway-mysql-init.sql     ← SQL inisialisasi database (jalankan sekali)
...
> `${{MySQL.MYSQL_URL}}` adalah Railway reference variable — otomatis terisi dari service MySQL.
